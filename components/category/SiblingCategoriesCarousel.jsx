...
export default function SiblingCategoriesCarousel({
  ...
  const [emblaRef, emblaApi] = useEmblaCarousel({
    loop: siblingCategories.length > 4,
    align: "start",
    duration: 25,
    dragFree: true,
  });
  ...
  const formattedParent = parentCategoryName.toLowerCase();
        ...
        <div className="flex flex-col sm:flex-row sm:items-end justify-between mb-8 sm:mb-12 gap-4">
          <div>
            ...
            <p className="font-body text-sm sm:text-base text-[#57534E] max-w-2xl mt-3 leading-relaxed">
              {siblingCategories.length} more surface{siblingCategories.length > 1 ? "s" : ""} from the same quarries, cut and finished in the same works.
            </p>
          </div>
