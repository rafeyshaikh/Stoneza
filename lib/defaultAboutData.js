export const defaultAboutData = {
  ...
  story: {
    ...
    image: {
      url: "/assets/others/Below_Banner_2.jpg",
      publicId: "",
    },
    paragraphs: [
    ...
    eras: [
      {
        ...
        description: "A family enterprise begins in Bhilwara, quarrying the renowned sandstone belts of Bijolia.",
      },
      {
        year: "2000s–2010s",
        title: "The house grows",
        description: "Owned quarries grow to Kota and Asind. In-house processing factories rise in Bhilwara.",
      },
      {
        year: "Today",
        title: "Owners & curators",
        description:
          "40+ signature stones. 1000+ architects served. Specified at landmark hospitality properties, delivered across India and exported to four continents.",
      },
    ],
  },
  stats: [
  ...
  founders: {
    ...
    image: {
      url: "/assets/others/Below_Banner_1.jpg",
      publicId: "",
    },
    people: [
      {
    ...
    steps: [
      {
        ...
        description: "One dedicated consultant understands your project — application, palette, timeline and budget.",
      },
      {
        number: "02",
        title: "Samples & specification",
        description: "Physical samples in 48 hours, mockup panels on request, spec sheets for the drawing board.",
      },
      {
        number: "03",
        title: "Production & QC",
        description: "Cut to your drawings, calibrated for level laying, and matched wet & dry — lot after lot.",
      },
      {
        number: "04",
        title: "Insured delivery",
        description: "Container-grade crating and insured transit with live order tracking to your site gate.",
      },
    ],
  },
  showroom: {
    ...
    description:
      "Walk the Stoneza experience centre in Bhilwara — real textures under real light, from CNC-carved feature walls to full-format flooring and cladding. Every material, waiting to be touched.",
  ...
  cta: {
    ...
    description:
      "Share what you're building, and a Stoneza consultant responds with factory-direct pricing, honest lead times and samples on their way — usually the same day.",
