...
export default function VerifyEmailClientView({ token }) {
  ...
  return (
    <section className="min-h-[80vh] flex items-center justify-center px-5">
      <div className="max-w-[500px] text-center">
        ...
        <Link
          href="/auth/login"
          className="inline-flex items-center justify-center h-[56px] px-8 bg-[#665b54] text-white tracking-[3px] text-xs cursor-pointer"
        >
          GO TO LOGIN
        </Link>
      </div>
