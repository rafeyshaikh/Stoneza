...
export default function LoginClientView() {
  ...
  const handleGetOtp = () => {
    toast.info("Phone OTP login coming soon. Please use email login.");
    setView("email");
  };
        ...
        {view === "phone" ? (
          ...
          <>
            ...
            <div className="mb-4">
              <div className="relative">
                ...
                <button
                  ...
                  className="absolute right-4 top-1/2 -translate-y-1/2 text-[#6f6f6f] hover:text-black transition-colors cursor-pointer"
                >
                  {showPassword ? (
            ...
            <Button
              onClick={handleLogin}
              disabled={loading}
              className="w-full h-[58px] bg-[#665b54] hover:bg-[#5a4f48] text-white tracking-[4px] text-[12px] font-heading rounded-none mb-8 font-normal cursor-pointer"
            >
              {loading && <Loader2 className="mr-2 h-4 w-4 animate-spin" />}
