          ...
          <div className="bg-white rounded-2xl p-7 shadow-sm border border-[#d4cfc9]">
            ...
            <form onSubmit={handleResetPassword} className="space-y-4">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <button
                    ...
                    className="absolute right-3 top-1/2 -translate-y-1/2 text-[#6f6f6f] hover:text-black"
                  >
              ...
              <button
                type="button"
                onClick={() => setStep(1)}
                className="w-full text-center text-xs text-[#78716c] hover:underline pt-2 block"
              >
