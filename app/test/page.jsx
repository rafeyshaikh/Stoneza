...
export default function ContactTestPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // API call or submission simulation
    ...
    <div className="bg-white text-[#26221E] font-sans antialiased">
      ...
      <section className="relative min-h-[clamp(320px,46vh,470px)] flex items-end px-4.5 sm:px-8 lg:px-16 py-[clamp(38px,6vw,74px)] overflow-hidden">
        <div
          ...
          style={{
            backgroundImage: `url('https://res.cloudinary.com/chlmognp/image/upload/v1785340267/stoneza/homepage/hero/newslide4-ms69hw8o.png')`,
          }}
        >
      ...
      <section className="bg-[#F5F1EB] py-[clamp(46px,6vw,86px)] border-t border-b border-[#26221E]/13">
        <div className="max-w-[1320px] mx-auto px-4.5 sm:px-8 lg:px-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-0 border-t border-[#26221E]">
            {/* Person 1: Saniya */}
            <div className="py-7 md:pr-8 lg:pr-10 border-b md:border-b-0 md:border-r border-[#26221E]/13">
              <span className="font-mono text-[9px] tracking-[0.16em] uppercase text-[#9C7233] block mb-2.75">
                Sales &mdash; first point of contact
              </span>
              <h3 className="font-serif text-[24px] font-normal mb-1">Saniya</h3>
              <p className="text-[13.5px] text-[#8A8078] mb-4">Sales Consultant</p>
              ...
              <span className="inline-block font-mono text-[8.5px] tracking-[0.13em] uppercase bg-[#F5F1EB] border border-[#CFC6B9] px-2.25 py-1.25 mt-4 text-[#57504A]">
                Quotations &middot; Samples &middot; Lead times
              </span>
            </div>

            {/* Person 2: Kanishk Ostwal */}
            <div className="py-7 md:pl-8 lg:pl-10">
              <span className="font-mono text-[9px] tracking-[0.16em] uppercase text-[#9C7233] block mb-2.75">
                Direct line
              </span>
              ...
              <p className="text-[13.5px] text-[#8A8078] mb-4">
                Director &mdash; Anantay Exports Pvt. Ltd.
              </p>
              <p className="text-[14px] leading-[1.68] text-[#57504A] mb-4.5 max-w-[42ch]">
                For large projects, specification support, partnership and distribution enquiries, export programmes, or anything that has not been resolved to your satisfaction. Reach out directly &mdash; it comes to me, not to a queue.
              </p>

              <div className="border-t border-[#26221E]/13">
                <a
                  href="tel:+919950036866"
                  className="flex gap-2.75 items-baseline py-2.5 border-b border-[#26221E]/13 no-underline text-[14.5px] text-[#26221E] hover:text-[#8E4B2A] transition-colors"
                >
                  <b className="font-mono text-[8.5px] tracking-[0.14em] uppercase text-[#8A8078] w-[74px] shrink-0 font-normal">
                    Phone
                ...
                <a
                  href="mailto:kanishk.ostwal@stoneza.in"
                  className="flex gap-2.75 items-baseline py-2.5 border-b border-[#26221E]/13 no-underline text-[14.5px] text-[#26221E] hover:text-[#8E4B2A] transition-colors"
                >
                  <b className="font-mono text-[8.5px] tracking-[0.14em] uppercase text-[#8A8078] w-[74px] shrink-0 font-normal">
                    Email
                  </b>
                  kanishk.ostwal@stoneza.in
                </a>
                <a
                  href="https://www.linkedin.com/company/thestoneza"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex gap-2.75 items-baseline py-2.5 border-b border-[#26221E]/13 no-underline text-[14.5px] text-[#26221E] hover:text-[#8E4B2A] transition-colors"
                >
              ...
              <span className="inline-block font-mono text-[8.5px] tracking-[0.13em] uppercase bg-[#F5F1EB] border border-[#CFC6B9] px-2.25 py-1.25 mt-4 text-[#57504A]">
                Projects &middot; Specification &middot; Partnerships &middot; Export
              </span>
            </div>
          </div>
        </div>
      ...
      <section className="py-[clamp(46px,6vw,86px)] border-b border-[#26221E]/13">
        <div className="max-w-[1320px] mx-auto px-4.5 sm:px-8 lg:px-16">
          ...
          <div className="aspect-[21/9] min-h-[360px] w-full border border-[#CFC6B9] relative overflow-hidden bg-[#F5F1EB]">
            <iframe
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d115682.49392576307!2d74.57076418854448!3d25.348612140417937!2m3!1f0!0f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3968c237a505b38d%3A0xb3cf51d8b72445b2!2sBhilwara%2C%20Rajasthan!5e0!3m2!1sen!2sin!4v1700000000000!5m2!1sen!2sin"
              width="100%"
              height="100%"
              style={{ border: 0 }}
              allowFullScreen=""
